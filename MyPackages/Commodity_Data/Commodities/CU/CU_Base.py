...
class CU_Base(CommonDataBaseClass):
    cmt_name = "CU"
    ...
    @staticmethod
    def get_CU_quote_df(month=None):
        tmp_df = QuoteData.Daily.get_cmt_quote("close", "CU.SHF", month=month)	
        return tmp_df


    
if __name__ == "__main__":
    aa = CU_Base.get_col_index_df()
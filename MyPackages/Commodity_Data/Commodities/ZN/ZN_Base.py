...
class ZN_Base(CommonDataBaseClass):
    cmt_name = "ZN"
    ...
    @staticmethod
    def get_ZN_quote_df(month=None):
        tmp_df = QuoteData.Daily.get_cmt_quote("close", "ZN.SHF", month=month)
        return tmp_df


    
if __name__ == "__main__":
    aa = ZN_Base.get_col_index_df()
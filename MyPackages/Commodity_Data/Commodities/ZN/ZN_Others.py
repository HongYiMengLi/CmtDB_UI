...
from MyFutureClass.CmtDataBase.Commodities.ZN.ZN_Base import ZN_Base
from ...Base.DataType_Base import Auto
from ...Base.Plot_Base import Plot_Base
from matplotlib.ticker import FuncFormatter
from . import ZN_Macro

class others_base(ZN_Base, Plot_Base):
...
class ZengZhiShui(others_base, Auto):
    ...
    col_name = u"增值税"
    def get_ts(self):
        tmp_table_df = ZN_Macro.JiQiHuiLv_MeiYuanDuiRenMinBi().get_ts()

...
from . import CF_SpotPrice, CF_Upstream
...
class FuZhuangXieMaoZhenFangZhiPinLeiLingShouE_DangYueZhi(downstream_base, WindData):
    field_name = u"成品内销"
    col_name = u"服装鞋帽针纺织品类零售额_当月值"
    wind_code = "M0045715"  

class FuZhuangXieMaoZhenFangZhiPinLeiLingShouE_LeiJiZhi(downstream_base, WindData):
    field_name = u"成品内销"
    col_name = u"服装鞋帽针纺织品类零售额_累计值"
    wind_code = "M0045755"  

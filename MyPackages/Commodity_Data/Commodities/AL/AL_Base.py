...
class AL_Base(CommonDataBaseClass):
    cmt_name = "AL"
    ...
    @staticmethod
    def get_AL_quote_df(month=None):
        tmp_df = QuoteData.Daily.get_cmt_quote("close", "AL.SHF", month=month)
        return tmp_df


    
if __name__ == "__main__":
    aa = AL_Base.get_col_index_df()
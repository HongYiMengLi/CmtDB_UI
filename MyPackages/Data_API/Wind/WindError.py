...
def WindCheck(wind_object):
    if wind_object.ErrorCode != 0:
        raise WindError(wind_object.ErrorCode,wind_object.Data[0][0])
...
class WindError(Exception):
    error_dict = {
                ...
                -40522018:"multi-codes with multi_indicator"                                     
            }
    def __init__(self,error_code,error_msg):
        super(WindError,self).__init__()
        self.errorinfo = "(" + WindError.error_dict[error_code] + ") " + error_msg
...
#    print a2.d
    ...
    w.start()
    a = w.wsi("A1609.DCE", "close", "2015-04-01 09:00:00", "2015-04-01 16:01:00", "")
    WindCheck(a)
